...
namespace editor.game_project
{
    ...
    class CreateProjectViewModel : ViewModelBase
    {
        ...
        private readonly string _templatePath = @"C:\dev\Game Engine\Fabric\editor\source\project_templates\";
        ...
        private void CreateSolution(ProjectTemplate template, string projectPath)
        {
            ...
            var engineAPIPath = Path.Combine(MainWindow.FabricPath, @"core\include\");
